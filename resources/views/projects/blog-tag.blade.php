...
@section('content')
<h2 class="fw-bold mb-3" style="font-size: 20px;"><u>Tag</u></h2>
{{-- <div style="border-radius: 14px;" class="row align-items-center mb-5 bg-white border p-5 mx-1">
    <div class="col-lg-2 col-3 text-center">
        <img style="width: 80px;" class="rounded-circle" src="{{ $author->avatar }}" alt="author-avatar">
    </div>
    <div class="col-lg-10 col-9 text-start remove-p-mb"> --}}
        <h1 style="font-size: 32px;" class="fw-bold mb-5 d-inline-flex mb-3 px-2 py-1 fw-semibold text-primary bg-primary bg-opacity-10 border border-primary border-opacity-10 rounded-2">{{ $tag_name }}</h1>
        {{-- {!! $author->bio !!} --}}
    {{-- </div>
</div> --}}
