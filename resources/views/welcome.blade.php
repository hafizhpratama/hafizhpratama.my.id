...
<div class="my-5 mx-3 py-5">
    <h2 class="fw-bold mb-3 color-black" style="font-size: 20px;">Tech Stacks</h2>
...
<div class="my-5 mx-3">
    <div class="row">
        <h2 class="fw-bold mb-3 color-black" style="font-size: 20px;">Experiences</h2>
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            ...
            <div class="col-md-9 py-4">
                <h3 style="font-size:20px;" class="card-title fw-bold color-black">Associate Software Engineer</h3>
        ...
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            ...
            <div class="col-md-9 py-4">
                <h3 style="font-size:20px;" class="card-title fw-bold color-black">Web Developer</h3>
...
<div class="my-5 py-5">
    <h2 class="fw-bold mb-3 color-black" style="font-size: 20px;">Projects</h2>
    <div class="list-group w-auto" style="border-radius: 14px;">
        <a href="https://b2cdemo.getswift.asia/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h3 style="font-size:16px;" class="mb-0 fw-bold color-black">SWIFT Apps Platform</h3>
                        <p class="mb-0 color-black">The ecommerce and omnichannel solution within your grasp.</p>
                    </div>
                </div>
            </div>
        </a>
        <a href="https://pwa.getswift.asia/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h3 style="font-size:16px;" class="mb-0 fw-bold color-black">SWIFT Omnichannel Platform</h3>
                        <p class="mb-0 color-black">A complete end-to-end omnichannel solution that allows you to sell
        ...
        <a href="https://covid19.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h3 style="font-size:16px;" class="mb-0 fw-bold color-black">Hukumonline Covid-19</h3>
                        <p class="mb-0 color-black">The covid19.hukumonline.com site is a form of Hukumonline's concern.
        ...
        <a href="https://lawfest.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h3 style="font-size:16px;" class="mb-0 fw-bold color-black">Hukumonline Law Festival</h3>
                        <p class="mb-0 color-black">This event is set to attract thousands of participants drawn from a
        ...
        <a href="https://bmtfajar.co.id/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h3 style="font-size:16px;" class="mb-0 fw-bold color-black">BMT Fajar</h3>
                        <p class="mb-0 color-black">BMT Fajar was started in 1996 by several people who were originally
