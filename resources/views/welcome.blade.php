...
<div class="container">
    <div class="mt-5 pt-4">
        <img style="border-radius: 50%; width: 96px;"
            src="https://copyfol.io/_next/image?url=https%3A%2F%2Fcopyfolio.s3.us-east-1.amazonaws.com%2Fclay2h9b1218308mpkeifvaht%2Fcropped_clayshmf1000o08mj50erewiv.jpeg&w=256&q=75"
            alt="image-profile">
    </div>
    <div class="mt-4 mb-5">
        ...
        <p style="font-weight: 400; font-size: 16px;">Experienced Software Engineer with a demonstrated history of
            ...
            individually. I am open-minded, adventurous, and like to dare challenges. Family, friends, and colleagues
            know me as a mix of phlegmatic and sanguine, with a predominance on the phlegmatic side. I love writing and
            reading as much as I love cats.
        </p>
    </div>
</div>
<div class="container my-5 py-5">
    <h2 class="fw-bold mb-3" style="font-size: 20px;">TECH STACK</h2>
    <div class="row align-items-center p-5" style="border-radius: 14px; background-color: white;">
        <div class="col-lg-3 col-6 text-center">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/220px-PHP-logo.svg.png"
                class="img-fluid" alt="tech-stack-image-1">
        </div>
        <div class="col-lg-3 col-6 text-center">
            <img src="https://www.duniailkom.com/wp-content/uploads/2020/03/Laravel-Featured-Image.png"
                class="img-fluid" alt="tech-stack-image-1">
        </div>
        <div class="col-lg-3 col-6 text-center">
            <img src="https://graphql.org/img/og-image.png" class="img-fluid" alt="tech-stack-image-1">
        </div>
        <div class="col-lg-3 col-6 text-center">
            <img src="https://logique.s3.ap-southeast-1.amazonaws.com/2021/06/apa-itu-mysql-11.jpg" class="img-fluid"
...
<div class="container my-5">
    <div class="row">
        <h2 class="fw-bold mb-3" style="font-size: 20px;">EXPERIENCE</h2>
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            <div class="col-md-4 text-center px-4 py-4">
                <img src="https://static1.squarespace.com/static/5b67d38bf8370a88da5af09c/t/5f6439797b4efc5ebc4e0481/1669188192707/"
                    class="img-fluid rounded-start" alt="image-company-1">
            </div>
            <div class="col-md-8 py-4">
                <h5 class="card-title fw-bold">Associate Software Engineer</h5>
        ...
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            <div class="col-md-4 text-center px-4 py-4">
                <img src="https://www.hukumonline.com/static/images/logo/hol-main-blue.png"
                    class="img-fluid rounded-start" alt="image-company-2">
            </div>
            <div class="col-md-8 py-4">
                <h5 class="card-title fw-bold">Web Developer</h5>
        ...
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            <div class="col-md-4 text-center px-4 py-4">
                <img src="https://static.vecteezy.com/system/resources/previews/000/592/901/non_2x/vector-office-building-icon.jpg"
                    class="img-fluid rounded-start" alt="image-company-3">
            </div>
            <div class="col-md-8 py-4">
                <h5 class="card-title fw-bold">Web Developer</h5>
        ...
        <div class="row g-0 align-items-center p-4 mb-3" style="background-color: white; border-radius: 14px;">
            <div class="col-md-4 text-center px-4 py-4">
                <img src="https://pbs.twimg.com/profile_images/1392811610717048834/GyeaLNsx_400x400.png"
                    class="img-fluid rounded-start" alt="image-company-4">
            </div>
            <div class="col-md-8 py-4">
                <h5 class="card-title fw-bold">Web Developer</h5>
...
<div class="my-5 py-5">
    <h2 class="fw-bold mb-3" style="font-size: 20px;">Project</h2>
    <div class="list-group w-auto" style="border-radius: 14px;">
        <a href="https://b2cdemo.getswift.asia/" target="_blank"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://static1.squarespace.com/static/5b67d38bf8370a88da5af09c/t/5f6439797b4efc5ebc4e0481/1669188192707/"
                        alt="twbs" width="100%" class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">SWIFT Apps Platform</h6>
        ...
        <a href="https://pwa.getswift.asia/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">SWIFT Omnichannel Platform</h6>
        ...
        <a href="/projects/openai" target="_blank" class="list-group-item list-group-item-action d-flex gap-3 p-5"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/OpenAI_Logo.svg/1280px-OpenAI_Logo.svg.png"
                        alt="twbs" width="100%" class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">OpenAI Ask Me Anything</h6>
        ...
        <a href="https://pkpa.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://www.hukumonline.com/static/images/logo/hol-main-blue.png" alt="twbs" width="100%"
                        class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Hukumonline Pendidikan Khusus Profesi Advokat</h6>
        ...
        <a href="https://exdoma.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Hukumonline Excellent Document Management</h6>
        ...
        <a href="http://rcs.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Hukumonline Regulatory Compliance System</h6>
        ...
        <a href="https://covid19.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Hukumonline Covid-19</h6>
        ...
        <a href="https://lawfest.hukumonline.com/" target="_blank"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Hukumonline Law Festival</h6>
        ...
        <a href="https://bmtfajar.co.id/" target="_blank"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://copyfol.io/_next/image?url=https%3A%2F%2Fcopyfolio.s3.us-east-1.amazonaws.com%2Fclay2h9b1218308mpkeifvaht%2Fclaz0hivr000a08l29ygb9yk4.png&w=3840&q=75"
                        alt="twbs" width="100%" class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">BMT Fajar</h6>
        ...
        <a href="https://lpka.umy.ac.id/" target="_blank"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://copyfol.io/_next/image?url=https%3A%2F%2Fcopyfolio.s3.us-east-1.amazonaws.com%2Fclay2h9b1218308mpkeifvaht%2Fclaz0evzq000908l2cwsq4f06.png&w=3840&q=75"
                        alt="twbs" width="100%" class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">LPKA (Lembaga Pengembangan Kemahasiswaan dan Alumni) UMY</h6>
        ...
        <a href="https://labip.umy.ac.id/" target="_blank"
            ...
            <div class="row align-items-center">
                <div class="col-sm-2 py-2">
                    <img src="https://copyfol.io/_next/image?url=https%3A%2F%2Fcopyfolio.s3.us-east-1.amazonaws.com%2Fclay2h9b1218308mpkeifvaht%2Fclaz0cqrv000808mnc04r70pe.png&w=3840&q=75"
                        alt="twbs" width="100%" class="">
                </div>
                <div class="col-sm-10 py-2">
                    <div>
                        <h6 class="mb-0 fw-bold">Laboratorium Ilmu Pemerintahan UMY</h6>
